...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        bindListener, getSceneAnimFrameRate, getSceneByAction, MediaHTML5,
...
createCSSRule('.enter-AR-button', "position: absolute; display: block; z-index: 1; background-color: rgba(255,255,255,0); width: 200px; height: 50px; bottom: 20px; left: 50%; margin-left: -100px; cursor: pointer; outline: 0;", false, '');
...
setHTMLElemAttribute('href', 'https://www.youtube.com/watch?v=M_aA09Y9t4g', 'info_button', false);
...
operateAnimation('PLAY', 'Psybi_armature', 0, 180, 'LoopRepeat', 1,
        function() {}, false);


volume(loadVideo('sounds/Popeye singing.mp3'), 1);
registerOnClick('psybi_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'Psybi_armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadVideo('sounds/Popeye singing.mp3'), false);

  operateAnimation('PLAY', 'Psybi_armature', 181, 270, 'LoopRepeat', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'psybi_group'], false);
      ...
      changeVis(['GROUP', 'psybi_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('Psybi_armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('Psybi_armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('psybi_mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', exportToUSDZ('ar'), 'enter_AR_button', false);
  setHTMLElemAttribute('download', exportToUSDZ('psybi.usdz'), 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'psybi_group'], true);
  setObjTransform('Psybi_armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('Psybi_armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnClick('edit_button', false, false, [0,1,2], function() {
  registerSetTimeout(0.1, function() {
    changeVis(['GROUP', 'psybi_group'], true);
    changeVis(['drag_move', 'drag_rotate', 'drag_scale', 'scale_percentage', 'ready_button'], true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('Psybi_armature', 'XY', 'WORLD', '=pY@HnxC4pWSm^3y}6b{', ']2`VMsFMrnMBE6e{_0Ll');
}, function() {}, ']2`VMsFMrnMBE6e{_0Ll');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('Psybi_armature', 'Z', 'WORLD', '9dwpm[Hw)+XlrlsT;P=7', '=JkBX!mWlWfl9dsWDdo+');
}, function() {}, '=JkBX!mWlWfl9dsWDdo+');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('Psybi_armature', 'Z', '|+pzd9ycb3(qbzgw4WJq', 'JF#EU{$j8s9?wh`kgAx%');
  dragScale('Psybi_armature', 'X', 'QypNnOHs1o?%qTzjFxHR', 'JF#EU{$j8s9?wh`kgAx%');
  dragScale('Psybi_armature', 'Y', '*@3rdHZHsu9xlVYEEN7W', 'JF#EU{$j8s9?wh`kgAx%');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('Psybi_armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'JF#EU{$j8s9?wh`kgAx%');
